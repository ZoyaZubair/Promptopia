...
const Home = () => {
  ...
  return (
    <section className="max-w-7x1 mx-auto">
      <div>
        <h1 className="font-extrabold text-[#222328] text-[32px]">Promptopia - The Community Showcase</h1>
      ...
      <div className="mt-16">
        <FormField 
          ...
          type="text"
          name="text"
          placeholder="Search the community generated posts"
          value={searchText}
          ...
          <>
            {searchText && (
              <h2 className="font-medium text-[#666e75] text-xl mb-3">
                Showing the results for <span className="text-[#222328]">{searchText}</span>
              </h2>
            )}
